    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "reference_mask": ("MASK",),
                "flux_fill_model": (folder_paths.get_filename_list("unet", extension=".safetensors"),),
                "flux_redux_model": (folder_paths.get_filename_list("style_models", extension=".safetensors"),),
                "lora_model": (folder_paths.get_filename_list("loras", extension=".safetensors"),),
